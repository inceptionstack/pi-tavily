...
Once loaded, the LLM can call the `tavily_web_search` tool to search the web for current information.
...
The LLM will call `tavily_web_search` with an appropriate query and incorporate the results into its response.
